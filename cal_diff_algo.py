...
input_file = source + dataname + '_' + str(deta) + '_' + str(low) + '/method_hou_Output/'
output_file = source + dataname + '_' + str(deta) + '_' + str(low) + '/cal_f1/diff_algo/'
...
for k in range(1, group_num+1):
    ...
    for kv in range(1,group_num+2):
        ...
        # # #i对比不同算法
        predPathDS = input_file + dataname + '_result_DS(k=' + str(kv) + ')'+method+ '_'+str(deta)+'(k='+str(k)+')'+ '.csv'
        predPathZC = input_file + dataname + '_result_ZC(k='+str(kv)+')'+method+'_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathMV = input_file + dataname + '_result_MV(k='+str(kv)+')'+method+'_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathGLAD = input_file + dataname + '_result_GLAD(k='+str(kv)+')'+method+'_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathPM = input_file + dataname + '_result_PM(k=' + str(kv) + ')' + method + '_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathBWA = input_file + dataname + '_result_BWA(k='+str(kv)+')'+method+'_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathBCC = input_file + dataname + '_result_BCC(k='+str(kv)+')'+method+'_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathEBCC = input_file + dataname + '_result_EBCC(k='+str(kv)+')'+method+'_'+str(deta)+'(k='+str(k)+')'+'.csv'
        predPathHC = input_file + dataname + '_result_HC(k='+str(kv)+')'+method + '_'+str(deta)+'(k='+str(k)+')'+ '.csv'
    ...
    # dataEBCC.to_csv(output_file + 'f1_score/' +dataname+'(k=' + str(k) + ')_F1_score_EBCC' + str(deta) +'.txt', index=False, sep=',')
    #
