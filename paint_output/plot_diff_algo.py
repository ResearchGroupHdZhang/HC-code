...
if __name__ == '__main__':
    ...
    input_file = source + dataname + '_' + str(deta) + '_' + str(low) + '/cal_f1/diff_algo/accuracy/'
    ...
    for k in range(1, group_num+1):
        ...
        x_list8, y_list8 = open_data(
            input_file + dataname + '(k=' + str(k) + ')_accuracy_HC_EBCC_' + str(deta) + '.txt')
        ...
        plt.plot(x_list8, y_list8, 'r-<', linewidth=1, label='Ours')

        # xmax = max(x_list+ x_list1+ x_list2+ x_list3+ x_list4+ x_list5+ x_list6+ x_list7 +x_list8)
        # ymax = math.ceil(max(y_list+ y_list1+ y_list2+ y_list3+ y_list4+ y_list5+ y_list6+ y_list7 +y_list8)) + 2
        # ymin = math.floor(min(y_list+ y_list1+ y_list2+ y_list3+ y_list4+ y_list5+ y_list6+ y_list7 +y_list8)) - 2

        xmax = max(x_list+ x_list1+ x_list2+ x_list4+ x_list5+ x_list6+ x_list7 +x_list8)
        ymax = math.ceil(max(y_list+ y_list1+ y_list2+ y_list4+ y_list5+ y_list6+ y_list7 +y_list8)) + 2
        ymin = math.floor(min(y_list+ y_list1+ y_list2+ y_list4+ y_list5+ y_list6+ y_list7 +y_list8)) - 2
        ...
        plt.savefig(output_file + dataname +'_'+ metric + '_compare_algo_k=' + str(k) + '_' + str(deta) +'.pdf', dpi=800)
        plt.show()
